...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Breaking: AI Revolutionizes News Verification'**
  String get article1Title;

  /// No description provided for @article1Summary.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @article1Source.
  ///
  /// In en, this message translates to:
  /// **'Tech News'**
  String get article1Source;
  ...
  /// No description provided for @article3Summary.
  ///
  /// In en, this message translates to:
  /// **'Technology stocks lead market gains as investors show confidence in AI sector growth.'**
  String get article3Summary;

  /// No description provided for @article3Source.
  ///
  /// In en, this message translates to:
  /// **'Business Today'**
  String get article3Source;
  ...
  /// No description provided for @article4Summary.
  ///
  /// In en, this message translates to:
  /// **'Scientists develop new immunotherapy that shows promising results in clinical trials.'**
  String get article4Summary;

  /// No description provided for @article4Source.
  ///
  /// In en, this message translates to:
  /// **'Health News'**
  String get article4Source;

  /// No description provided for @article5Title.
  ///
  /// In en, this message translates to:
  /// **'SpaceX Announces Mars Mission Timeline'**
  String get article5Title;

  /// No description provided for @article5Summary.
  ///
  /// In en, this message translates to:
  /// **'Elon Musk reveals updated plans for the first crewed mission to Mars in 2028.'**
  String get article5Summary;

  /// No description provided for @article5Source.
  ///
  /// In en, this message translates to:
  /// **'Space Journal'**
  String get article5Source;

  /// No description provided for @article6Title.
  ///
  /// In en, this message translates to:
  /// **'Olympics 2026 Preparations Underway'**
  String get article6Title;

  /// No description provided for @article6Summary.
  ///
  /// In en, this message translates to:
  /// **'Host city unveils state-of-the-art facilities for upcoming Olympic Games.'**
  String get article6Summary;

  /// No description provided for @article6Source.
  ///
  /// In en, this message translates to:
  /// **'Sports World'**
  String get article6Source;
